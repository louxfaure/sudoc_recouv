...
class Library(models.Model):
    ...
    library_rcr = models.CharField(max_length=10,verbose_name=u"RCR de la bibliotheque",unique=False)
...
class Process(models.Model):
    ...
    def get_url(self, attr) :
        ...
        if getattr(self,attr) > 0 :
            return format_html(
                '<a href="/admin/sudoc_recouv/error/?error_process__id__exact={}&error_type__exact={}&error_process__process_library__id__exact={}">{}</a>',
                self.id,
                dict_error[attr],
